...
export class Product extends AbstractModel implements ProductInterface {
  ...
  public static readonly modelAttributes = {
    ...
    name: {
      ...
      set(value: string) {this.setDataValue('name', value)}
    },
    active: {
      type: DataTypes.BOOLEAN,
      defaultValue: true,
      set(value: boolean) {this.setDataValue('active', value)}
    },
    productNumber: {
      field: 'product_number',
      type: new DataTypes.STRING(30),
      allowNull: false,
      get() {return this.getDataValue('productNumber')},
      set(value: string) {this.setDataValue('productNumber', value)}
    },
    createdAt: {
      field: 'created_at',
      type: DataTypes.DATE,
